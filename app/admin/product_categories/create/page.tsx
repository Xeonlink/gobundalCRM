...
import { defaultProductCategory, useCreateProductCategory } from "@/api/product_categories";
...
export default function Page() {
  ...
  const [category, categoryActions] = useTypeSafeReducer(defaultProductCategory, {
    toggleEnabled: (state) => {
    ...
    reset: () => defaultProductCategory,
  });
  const createItem = useCreateProductCategory(category, {
