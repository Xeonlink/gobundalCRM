...
export default function Page() {
  ...
  return (
    <Dialog className="dsy-modal" autoOpen>
      <form action={runAction} className="dsy-modal-box p-0">
        {/* Toolbar */}
        <ul className="flex flex-wrap items-center justify-center bg-base-200  py-2 max-sm:flex-col">
          <li>
            <Back
